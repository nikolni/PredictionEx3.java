...
public class PRDWorldValidator {
    ...
    public void checkNumericFunctionsParamType(PRDWorld prdWorld){
        for(PRDRule prdRule:prdWorld.getPRDRules().getPRDRule())
            for(PRDAction prdAction:prdRule.getPRDActions().getPRDAction()){
                checkNumericParamTypeInSingleAction(prdAction,prdRule,prdWorld.getPRDEnvironment(),prdWorld.getPRDEntities().getPRDEntity());
            }
    }

    public void checkNumericParamTypeInSingleAction(PRDAction prdAction,PRDRule prdRule,PRDEnvironment prdEvironment,List<PRDEntity> prdEntityList){
    ...
    public void checkIncreaseDecreaseFunctionsParamTypes(PRDRule prdRule,PRDAction prdAction,List<PRDEntity> prdEntityList,PRDEnvironment prdEvironment){
    ...
    public void checkCalculationFunctionParamType(PRDRule prdRule,PRDAction prdAction,List<PRDEntity> prdEntityList,PRDEnvironment prdEvironment){
    ...
    public void checkMultiplyCalculation(String arg1Exp,String arg2Exp,Type enumResultPropType,PRDRule prdRule,PRDAction prdAction,List<PRDEntity> prdEntityList,PRDEnvironment prdEvironment){
    ...
    public void checkDivideCalculation(String arg1Exp,String arg2Exp,PRDRule prdRule,PRDAction prdAction,List<PRDEntity> prdEntityList,PRDEnvironment prdEvironment){
        Type enumArg1Type=getExpressionType(arg1Exp,getEntityByName(prdAction.getEntity(),prdEntityList),prdEvironment);
        checkIfExpressionOrPropertyIsNumeric(enumArg1Type,arg1Exp,prdRule.getName(),prdAction.getType());
        Type enumArg2Type=getExpressionType(arg2Exp,getEntityByName(prdAction.getEntity(),prdEntityList),prdEvironment);
        checkIfExpressionOrPropertyIsNumeric(enumArg2Type,arg2Exp,prdRule.getName(),prdAction.getType());
    ...
    public Type getExpressionType(String ExpressionStr,PRDEntity currentEntity,PRDEnvironment prdEvironment){
