package component.body.execution.main;

import component.body.execution.start.button.error.ErrorExecutionScreenController;
import component.body.execution.start.button.good.StartButtonController;
import component.body.execution.task.RunSimulationTask;
import component.body.execution.tile.TileResourceConstants;
import component.body.execution.tile.entity.EntityController;
...
public class ExecutionController {
    ...
    void onClickStartButton(MouseEvent event) {
        if(checkInputsValidity()){
            ...
            try{
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/component/body/execution/start/button/good/startButton.fxml"));
