package component.body.running.main;

import component.body.running.list.view.update.UpdateListView;
import component.body.running.result.ResultsController;
import component.body.running.simulation.progress.SimulationProgressController;
import component.body.running.simulation.progress.task.UpdateUiTask;
...
public class ProgressAndResultController {
    ...
    public void createAndAddNewSimulationResultToList(DTOSimulationEndingForUi dtoSimulationEndingForUi) {
        ...
        try{
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/component/body/running/result/results.fxml"));
